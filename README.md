Arbitrary Precision Calculator (APC) – C Project

📌 Description
This project implements an Arbitrary Precision Calculator (APC) in C, capable of performing arithmetic operations on very large integers that exceed the limits of built-in data types. The calculator represents numbers using doubly linked lists, enabling digit-by-digit operations similar to manual arithmetic.
